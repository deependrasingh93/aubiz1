...
uint256 hashGenesisBlock("0xdab56d1bb91f395f27ad844886cbd679b860dd8ca3d3a913bb190a2a8bf06219");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Aubiz: 1 days
static const int64 nTargetSpacing = 1 * 60; // Aubiz: 1 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xac2287e1d27843738b897bfa5d7b6e4309e69b67f0aa9a3c9b25f07c1e9d8266");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "birth of aubiz";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045340402d26bac281353b0046c9ceb0729b515744e3ef1ebbea0fedb834d02aee945ac7eb3a9cd5e90cdcc8fe73259b65319de179aca8b444a6463403f791a5b5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1531306807;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084836751;

        if (fTestNet)
        {
            block.nTime    = 1531306831;
            block.nNonce   = 387741858;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4b71eceb35fad79ea01cbf09eda0b5c7c011c7be4959f9234ee5cf1cde69fe05"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc2, 0xb7, 0xdc };// Aubiz: increase each by adding 2 to bitcoin's value.
